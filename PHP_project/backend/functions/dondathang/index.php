...
<head>
    ...
    <!-- DataTable CSS -->
    <link rel="stylesheet" href="/PHP_project/assets/vendor/DataTables/datatables.min.css">
    <link rel="stylesheet" href="/PHP_project/assets/vendor/DataTables/Buttons-1.6.3/css/buttons.bootstrap4.min.css">
    <link rel="stylesheet" href="/PHP_project/assets/vendor/paper-css/paper.css">
</head>
<body>
     <!-- header -->
...
EOT;
    ...
    <!-- end footer -->
     ...
     <script src = "/PHP_project/assets/vendor/DataTables/datatables.min.js"></script>
     <script src = "/PHP_project/assets/vendor/DataTables/Buttons-1.6.3/js/buttons.bootstrap4.min.js"></script>
     <script src = "/PHP_project/assets/vendor/DataTables/pdfmake-0.1.36/pdfmake.min.js"></script>
     <script src = "/PHP_project/assets/vendor/DataTables/pdfmake-0.1.36/vfs_fonts.js"></script>
     <script src="/PHP_project/assets/vendor/sweetalert/sweetalert.min.js"></script>
      <!-- SweetAlert -->
    <script src="/PHP_project/assets/vendor/sweetalert/sweetalert.min.js"></script>
    <script>
